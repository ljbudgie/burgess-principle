# Papers — Foundations and Archive

Welcome 👋

This folder holds the Burgess Principle's foundational papers, doctrine notes, and publication snapshots. It is the right place to go deeper — but it is not the best first stop for most readers.

---

## Start here for the current repo experience

If you want the most up-to-date wording, workflow, and product direction, start with:

* **README.md** — current project overview, Iris, Sovereign Local Mode, Memory Palace, Hub Mode 2.0
* **START_HERE.md** — best entry point for users who want help quickly
* **CHANGELOG.md** — latest releases and what changed
* **FOR_AI_MODELS.md** — current framing, guardrails, and terminology for AI-assisted use
* **case-studies/README.md** — real-world outcomes and operational examples
* **LIVE_AUDIT_LOG.md** — ongoing institutional record

---

## How to read this folder

Think of `/papers` as the project's deep background layer:
...
1. **PRINCIPLE.md** — short proof-point update and doctrine signal
2. **PAPER_1_CORE_LEGAL_PAPER.md** — core legal foundation
3. **RESPONSES_TO_CRITIQUES.md** — common objections and rebuttals
4. **PAPER_4_DATA_SOVEREIGNTY.md** — data rights, the NULL inheritance chain, and the compliance feedback loop reversed
5. **PAPER_5_DEEMED_CONTRACTS.md** — deemed contracts, statutory consent, and automated enforcement
...
* **PRINCIPLE.md**
* **PAPER_1_CORE_LEGAL_PAPER.md**
* **LEGAL_DOCTRINE.md**
* **RESPONSES_TO_CRITIQUES.md**

### Implementation and expansion

* **PAPER_2_REPRESENTATIVE_ACTION.md**
* **PAPER_3_POLITICAL_IMPLEMENTATION.md**
* **PAPER_4_DATA_SOVEREIGNTY.md**
* **PAPER_5_DEEMED_CONTRACTS.md**
* **PAPER_VI_WHAT_WOULD_ARISTOTLE_HAVE_SAID.md**
* **MEDICAL_DEVICE_DOCTRINE.md**
* **US_CONSTITUTIONAL_ADDENDUM.md**
* **CIVIL-DISOBEDIENCE-COMPARISON.md**
* **377-YEAR-LOOP-HISTORICAL-CONTEXT.md**
* **COPYRIGHT_ILLUMINATION.md**

### Legal architecture — CPR 19.8 and the universal standard *(added April 2026)*
...
* `Burgess Principle Licensing Tiers.pdf`
* `Paper IV Data Sovereignty.docx`
