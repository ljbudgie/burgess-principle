...
- **Response Summary:** Executive complaints handler Nitin Patel confirmed contract expired January 2022. Stated meter was functioning correctly while own bill shows reading frozen at 1458. Asked complainant for photograph of evidence own billing system already held. Charged £425 for enforcement visit being challenged.
...
- **Question Asked:** Were 42 PCNs individually reviewed by a judicial authority before enforcement?
...
- **Response Summary:** DSAR acknowledged 6 March 2026. No substantive response.
...
- **Response Summary:** Searched systems, found no records. Explained controller/processor distinction. Clean negative.
...
SOVEREIGN findings are documented with equal weight in this register. The framework identifies institutional compliance as well as failure. The Wave Utilities resolution (Entry 7) demonstrates what happens when a human mind is present: Erica individually reviewed both accounts, identified every error the automated system had missed, and resolved all issues in a single exchange. The same framework that identifies NULL processing also recognises when an institution meets the standard. The test is neutral — the outcome depends on the institution.
