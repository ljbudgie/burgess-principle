...
<!--
  ...
  Certified accountability framework: "Was a human member of the team able to
  personally review the specific facts of my specific situation?" Meaningful human
  involvement (Articles 22A–22D UK GDPR / Data Use and Access Act 2025) as a binary
  test — SOVEREIGN or NULL. UK Certification Mark UK00004343685. Templates, litigation
  tools, Sovereign Personal Vault. The human-first standard for automated decisions.

  SUGGESTED TOPICS (add via Settings > General > Topics):
  automated-decisions, human-rights, data-protection, uk-gdpr, article-22,
...
For the full story, see <SOUL.md>.
...
The Data (Use and Access) Act 2025 (DUAA 2025) brought **Articles 22A–22D UK GDPR** into force on **5 February 2026**, replacing the original Article 22. The central statutory standard is **meaningful human involvement** in automated decisions that produce legal or similarly significant effects on individuals.

A decision is **solely automated** — and subject to additional safeguards — when it is made with **no meaningful human involvement**.

The Burgess Principle arrived at the same standard independently — from personal necessity, not from the statute.

|Burgess Principle                                                                                          |Articles 22A–22D UK GDPR                                                      |
|-----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|
|**“Was a human member of the team able to personally review the specific facts of my specific situation?”**|Was there **meaningful human involvement** in this automated decision?        |
|**SOVEREIGN** — yes, a named human reviewed the specific facts                                             |Decision includes meaningful human involvement — statutory standard met       |
|**NULL** — no individual human review took place                                                           |Decision is **solely automated** — statutory safeguards apply                 |
|**AMBIGUOUS** — vague process language without confirming specific review                                  |Claimed compliance without substance — does not satisfy the statutory standard|

The convergence matters: an institution that returns a NULL result under the binary test is not merely failing the Burgess Principle. It is in breach of UK law.

The certification mark (**UK00004343685**) certifies that a specific institutional process includes meaningful human involvement. An institution is either **certified** or **classified** — meaning it has already, by operating its automated process, created a class of affected individuals with the same interest under CPR 19.8.

Full statutory analysis: [PAPER_1_CORE_LEGAL_PAPER.md](papers/PAPER_1_CORE_LEGAL_PAPER.md) · Common questions: <FAQ.md>
...
|--------------------------|---------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
|Energy Ombudsman          |**EG021819-26**                                                            |E.ON — unsigned warrant, forced entry, smart meter dispute — **£129M claim** · Litigation active: Bindmans LLP (CFA ref BUR303), HMCTS ref 80553951|
...
|Data protection regulator |**ICO**                                                                    |Article 22 and DSAR complaints across multiple institutions                                                                                        |
...
A live, dated tracker is maintained in <STATUS.md>.
...
Full instructions: <SOVEREIGN_MODE.md>
...
See <enforcement/sovereign-vault/README.md> and <enforcement/sovereign-vault/COMMITMENT_ONLY_WORKFLOW.md>.
...
- <templates/README.md> — primary template index
- <templates/COMMON_SCENARIOS.md> — quick routing guide
- <START_HERE.md> — best first stop for new users
...
Full index: <case-studies/README.md>

-----

## Papers

The doctrinal foundations are in <papers/>. Recommended reading order:

1. [PRINCIPLE.md](papers/PRINCIPLE.md) — short proof-point and doctrine signal
1. [PAPER_1_CORE_LEGAL_PAPER.md](papers/PAPER_1_CORE_LEGAL_PAPER.md) — core legal foundation
1. [RESPONSES_TO_CRITIQUES.md](papers/RESPONSES_TO_CRITIQUES.md) — common objections and rebuttals
1. [PAPER_4_DATA_SOVEREIGNTY.md](papers/PAPER_4_DATA_SOVEREIGNTY.md) — data rights extension
1. [PAPER_5_DEEMED_CONTRACTS.md](papers/PAPER_5_DEEMED_CONTRACTS.md) — automated enforcement and deemed consent
1. [PAPER_VI_WHAT_WOULD_ARISTOTLE_HAVE_SAID.md](papers/PAPER_VI_WHAT_WOULD_ARISTOTLE_HAVE_SAID.md) — first principles and *epieikeia*
1. [PAPER_VII_NULL_ACROSS_THE_CLASS.md](papers/PAPER_VII_NULL_ACROSS_THE_CLASS.md) — defendant-side class definition for CPR 19.8 representative actions
1. [PAPER_VIII_THE_UNIVERSAL_STANDARD.md](papers/PAPER_VIII_THE_UNIVERSAL_STANDARD.md) — every system not Burgess certified is a potential defendant
1. [paper-IX-sovereign-pattern.md](papers/paper-IX-sovereign-pattern.md) — the binary test traced through scripture from Genesis to Revelation
1. [paper-X-restored-keeper.md](papers/paper-X-restored-keeper.md) — the redemptive pathway from NULL to SOVEREIGN
1. [PAPER_XI_THE_MYTHOS_THRESHOLD.md](papers/PAPER_XI_THE_MYTHOS_THRESHOLD.md) — Mythos-class frontier AI, Project Glasswing, and per-deployment named human review
1. [PAPER_XII_BURGESS_NOTICE_AND_MASS_TARIFF_PROCESSING.md](papers/PAPER_XII_BURGESS_NOTICE_AND_MASS_TARIFF_PROCESSING.md) — Burgess notice and mass tariff processing: convergence with *Burgess v. MSPB* (Fed. Cir. 1985); the individual review requirement applied to $159B in US tariff refunds and categorical UK business tariffs *(new in v2.2.0 — read alongside Paper XIII)*
1. [PAPER_XIII_REVERSE_ENGINEERING_HARMS.md](papers/PAPER_XIII_REVERSE_ENGINEERING_HARMS.md) — reverse-engineering harms: tracing iatrogenic injury through institutional failure across gender medicine, opioids, thalidomide, and surgical mesh *(new in v2.2.0 — read alongside Paper XII)*

Paper XI opens the frontier-AI arc: Mythos-class capability is legitimate only
where a named human reviews the specific facts of the specific deployment before
action. Papers XII and XIII are a pair. Paper XIII operates at the most intimate
scale of institutional power — decisions made inside a specific child’s body
without individual human review. Paper XII operates at the most geopolitical
scale — $159 billion in trade decisions processed categorically without
individual review of any specific business. The structure of the failure is
identical in both. The question is the same. Together they demonstrate that the
binary test applies wherever institutional power meets a specific human being —
regardless of scale, domain, or jurisdiction.
...
|Path               |What’s inside                                                                               |
|-------------------|--------------------------------------------------------------------------------------------|
|<START_HERE.md>    |Guided entry point for new users                                                            |
|<FAQ.md>           |Common questions — statutory convergence, certification, self-representation, AI            |
|<SOUL.md>          |Why this exists and where it came from                                                      |
|<SOVEREIGN_MODE.md>|Full local-first setup and Memory Palace walkthrough                                        |
|<FOR_AI_MODELS.md> |How AI systems should engage with the framework — and how it applies to them                |
|<STATUS.md>        |Live proceedings tracker                                                                    |
|<LIVE_AUDIT_LOG.md>|Dated institutional audit record                                                            |
|<templates/>       |Ready-to-send templates with routing guide                                                  |
|<case-studies/>    |Real-world outcomes with status and recommended templates                                   |
|<papers/>          |Foundational papers and doctrine                                                            |
|<enforcement/>     |Sovereign Personal Vault and enforcement tooling                                            |
|<litigation/>      |CPR 19.8 starter pack, damages matrix, warrant defect identifier, contamination chain mapper|
|<onchain-protocol/>|Optional on-chain claims protocol                                                           |
|<ARCHITECTURE.md>  |Ledger and sync architecture                                                                |
...
|Version                                                                        |Summary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|-------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|**[v2.2.0](https://github.com/ljbudgie/burgess-principle/releases/tag/v2.2.0)**|Two new papers released as a pair — Paper XIII: Reverse-Engineering Harms (iatrogenic medical harm methodology across gender medicine, opioids, thalidomide, surgical mesh) and Paper XII: Burgess Notice (convergence with *Burgess v. MSPB* Fed. Cir. 1985; $159B US tariff refund obligation; categorical UK business tariffs). Medical accountability template. Together they apply the binary test from the most intimate to the most geopolitical scale of institutional power. *(Released 25 April 2026 — first day of full-time work on the framework)*|
