...
Autism is legally a disability under the UK Equality Act 2010. This gives everyone the right to ask for **reasonable adjustments** — such as email-only contact to avoid phone calls or sensory overload.

These gentle memes help explain that the Burgess Principle and the Equality Act work beautifully together.

**Ready-to-copy Grok Imagine prompts:**

1. "Gentle two-panel meme in warm cartoon style. Left panel: overwhelmed autistic person on a phone call with swirling sensory overload icons. Right panel: same person calmly typing an email with a friendly human reviewer at the other end. Text: 'Reasonable adjustment under the Equality Act + Burgess Principle: email contact only so a real human can actually see my specific situation.' Warm colours, positive vibe, #BurgessPrinciple #EqualityAct"

2. "Friendly split-image meme. Left side: robot saying 'Call us on this number'. Right side: smiling human reviewer reading an email. Caption: 'Equality Act reasonable adjustment + Burgess Principle = email only so my specific needs are actually seen #BurgessPrinciple #EqualityAct'"
