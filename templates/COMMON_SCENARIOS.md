...
| --- | --- | --- |
| I just need a calm first letter | [`REQUEST_FOR_HUMAN_REVIEW.md`](./REQUEST_FOR_HUMAN_REVIEW.md) | Best default for almost any institution |
...
If your case involves sensitive facts:

1. Keep the full details in the **Sovereign Personal Vault** first.
