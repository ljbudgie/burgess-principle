...
Not sure which one? Drop the whole repo into [Grok](https://grok.com), [Claude](https://claude.ai), [ChatGPT](https://chat.openai.com), or any AI assistant and describe your situation — it will pick the right template for you.

### 2. I want to understand the idea first

Read the [README](README.md) — it explains the origin story, how the principle works, and real-world results.

### 3. I want step-by-step guidance

Check out the [tutorials](./tutorials) folder for walkthroughs.

### 4. I want to go deeper

These folders are for people who want to explore the framework, doctrine, and strategy behind the principle:
