...
This is **not legal advice**. The templates, guidance, and all other materials in this repository are provided as helpful tools only. They do not create a solicitor–client relationship and are not a substitute for professional legal counsel.
...
The Burgess Principle's core belief is that every person should be seen as an individual. We encourage you to adapt any template to your own circumstances and communication needs — including any accessibility requirements, sensory needs, or reasonable adjustments you are entitled to. The templates are starting points, not fixed scripts.
