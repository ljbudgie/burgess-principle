...
## Scored Institution Register

### Wave Utilities — SOVEREIGN (16 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 4 | 4 | 3 | 4 | 1 | 16 / 20 |

Directly answered; named case handler; specific facts cited; both accounts cleared to £0.00; £795.14 fees removed. Positive precedent — the template outcome.

---

### E.ON / E.ON Field Debt Solutions — NULL (1 / 20)
...
### HMCTS / Birmingham Magistrates' Court — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 1 | 0 | 0 | 0 | 0 | 1 / 20 |

Andrew Fletcher confirmed CSV batch processing, dip sampling 5/100, en bloc granting. 536,139 warrants in 18 months. D1 scores 1: substantive and direct, but confirmed a systemic NULL.

---

### British Gas / Centrica — NULL (3 / 20)
...
### Darlington Borough Council — NULL (3 / 20, updated 22 April 2026)
...
Confirmed data processor role; no independent debt verification. Pulled back by Wave on resolution. D1 scores 2: answered directly, did not evade, but confirmed NULL.

---

### Trading 212 UK Ltd — NULL (2 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 1 | 0 | 1 | 0 | 0 | 2 / 20 |

Weasel Response Detected. Seven DSAR categories unanswered. Active ICO complaint.
...
Template responses; six specific points unanswered. Part of four-institution pattern letter (IC-4999654-T1Q8).

---

### Phonak / Sonova UK Ltd — NULL (1 / 20)
...
### TV Licensing / BBC — Partial sovereign (12 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 3 | 2 | 3 | 3 | 1 | 12 / 20 |

Enforcement letters ceased on record correction. Most replicable outcome after Wave Utilities. DSAR still pending.
...
### Information Commissioner's Office — NULL (1 / 20)
...
### Home Office — NULL (2 / 20, updated 22 April 2026)
...
### Reddit Inc. — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

Account restricted with no notification or human review. Self-referential NULL. UK GDPR Article 22 applies.
...
### Cabinet Office — Pending (1 / 20 provisional)
...
## Aggregate Taxonomy Summary

| Institution | Domain | Score | Band |
| --- | --- | --- | --- |
| Wave Utilities | Water | 16 / 20 | SOVEREIGN |
| TV Licensing / BBC | Broadcasting | 12 / 20 | Partial sovereign |
| British Gas / Centrica | Energy | 3 / 20 | NULL |
| iC&R | Debt collection | 3 / 20 | NULL |
| Darlington Borough Council | Local authority | 3 / 20 | NULL (provisional) |
| Food Standards Agency | Government | 4 / 20 | Pending |
| Northumbrian Water | Water | 2 / 20 | NULL |
| Trading 212 | Financial technology | 2 / 20 | NULL |
| Vanquis Bank | Consumer credit | 2 / 20 | NULL |
| Home Office | Government | 2 / 20 | NULL (provisional) |
| E.ON / E.ON Field Debt Solutions | Enforcement | 1 / 20 | NULL |
| HMCTS / Birmingham Magistrates' Court | Courts | 1 / 20 | NULL |
| Equifax | Credit reference | 1 / 20 | NULL |
| Apple Inc. | Consumer technology | 1 / 20 | NULL |
| Phonak / Sonova | Medical devices | 1 / 20 | NULL |
| HMPO | Identity documents | 1 / 20 | NULL (provisional) |
| Reddit Inc. | Social media | 1 / 20 | NULL |
| ICO | Regulator | 1 / 20 | NULL |
...
- Standard rebuttal: request a direct YES/NO and, if YES, the name and role of the reviewer.
...
*(Full institutional details maintained in the [Institutional Register](INSTITUTIONAL_REGISTER.md).)*
