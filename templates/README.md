...
These are the ready-to-send Burgess Principle templates.
...
If you are not sure where to start, use one of the defaults below and personalise it.
...
## Crypto, evidence, and privacy-preserving proof
...
## Platform, media, and creative work
...
## Specialist and advanced templates

These are more specialised or context-specific. If in doubt, start with a core template first.

- [`AMERICAN_CONSTITUTIONAL_WITH_BURGESS.md`](./AMERICAN_CONSTITUTIONAL_WITH_BURGESS.md)
- [`BSL_ADAPTATIONS.md`](./BSL_ADAPTATIONS.md)
- [`DEI_WITH_BURGESS.md`](./DEI_WITH_BURGESS.md)
- [`MALICIOUS_COMMUNICATIONS_WITH_BURGESS.md`](./MALICIOUS_COMMUNICATIONS_WITH_BURGESS.md)
- [`NOTICE_OF_NULLITY_ADVANCED.md`](./NOTICE_OF_NULLITY_ADVANCED.md)
- [`POLITICIAN_CONTRADICTION_WITH_BURGESS.md`](./POLITICIAN_CONTRADICTION_WITH_BURGESS.md)
- [`PUBLIC_SPENDING_PRIORITY_WITH_BURGESS.md`](./PUBLIC_SPENDING_PRIORITY_WITH_BURGESS.md)
- [`VACCINE_HARM_WITH_BURGESS.md`](./VACCINE_HARM_WITH_BURGESS.md)
- [`data_sovereignty_request.md`](./data_sovereignty_request.md)
- [`institutional_scrutiny_template.md`](./institutional_scrutiny_template.md)
- [`sovereignty_declaration.md`](./sovereignty_declaration.md)
