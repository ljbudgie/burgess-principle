...
1. [PAPER_XI_REVERSE_ENGINEERING_HARMS.md](papers/PAPER_XI_REVERSE_ENGINEERING_HARMS.md) — reverse-engineering harms: tracing iatrogenic injury through institutional failure across gender medicine, opioids, thalidomide, and surgical mesh *(new in v2.2.0 — read alongside Paper XII)*
