...
| **[v0.4.0](https://github.com/ljbudgie/burgess-principle/releases/tag/v0.4.0)** | On-Chain Burgess Claims — optional EVM L2 commitment fingerprinting with no personal data on-chain. |
